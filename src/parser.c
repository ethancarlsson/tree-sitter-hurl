...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    [sym_entry] = STATE(41),
    [sym__request_response] = STATE(12),
    [sym_request] = STATE(8),
    [sym_http_method] = STATE(40),
    [aux_sym_entry_repeat1] = STATE(12),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__request_response, 1),
  [61] = {.entry = {.count = 1, .reusable = true}}, SHIFT(52),
  [63] = {.entry = {.count = 1, .reusable = false}}, SHIFT(52),
  [65] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_entry_repeat1, 2),
  [67] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_entry_repeat1, 2), SHIFT_REPEAT(46),
  ...
  [78] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_entry, 1),
  ...
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__request_response, 2),
